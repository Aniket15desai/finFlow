...
export default function FreeFunding() {
    return (
                ...
                <div className="mx-auto max-w-6xl grid grid-cols-1 lg:grid-cols-2 items-center gap-8">
                    <div className="space-y-4 text-center lg:text-left">
                        ...
                        <h3 className="text-2xl md:text-3xl lg:text-[40px] font-semibold text-gray-900">
                            Unlock Flexible, Interest-Free Funding
                        </h3>

                        <p className="text-base md:text-lg text-black text-opacity-35">
                            Extend your cash flow with flexible credit lines, offering up to 90-day payment terms. 
                            Enjoy interest-free capital for business growth and stability.
                        </p>
